...
export class CalendarQuarter extends CalendarUnitOfTime implements IHaveAQuarter {
  ...
  public equals(value: CalendarQuarter) {
    if (this === value) {
      return true
    }
    if (!((value as any) instanceof CalendarQuarter)) {
      return false
    }
