...
export class CalendarMonth extends CalendarUnitOfTime implements IHaveAMonth {
  ...
  public equals(value: CalendarMonth) {
    if (this === value) {
      return true
    }
    if (!((value as any) instanceof CalendarMonth)) {
      return false
    }
  ...
  public toString(): string {
    ...
    const result = `${this.monthNumber}${monthNumberSuffix} month of CY${this.year.toString().padStart(4, '0')}`
    return result
  }
}
