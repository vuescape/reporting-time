...
export class FiscalMonth extends FiscalUnitOfTime implements IHaveAMonth {
  ...
  public equals(value: FiscalMonth) {
    if (this === value) {
      return true
    }
    if (!((value as any) instanceof FiscalMonth)) {
      return false
    }
  ...
  public toString(): string {
    ...
    const result = `${this.monthNumber}${monthNumberSuffix} month of FY${this.year.toString().padStart(4, '0')}`
    return result
  }
}
