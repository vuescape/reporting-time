...
describe('CalendarQuarter --', () => {
  describe('equals --', () => {
    it('should return true when testing the same instance', () => {
      // Arrange
      const calendarQuarter = new CalendarQuarter(2000, QuarterNumber.Q1)

      // Act
      const result = calendarQuarter.equals(calendarQuarter)
    ...
    it('should return true when different instances have the same year', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2000, QuarterNumber.Q1)
      const calendarQuarter2 = new CalendarQuarter(2000, QuarterNumber.Q1)

      // Act
      const result = calendarQuarter1.equals(calendarQuarter2)
    ...
    it('should return false when years are different', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2020, QuarterNumber.Q1)
      const calendarQuarter2 = new CalendarQuarter(2000, QuarterNumber.Q1)
    ...
    it('should return false when QuarterNumbers are different and years are the same', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2020, QuarterNumber.Q1)
      const calendarQuarter2 = new CalendarQuarter(2020, QuarterNumber.Q4)
    ...
    it('should return false when CalendarQuarter is undefined', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2020, QuarterNumber.Q2)
      const calendarQuarter2 = (undefined as any) as CalendarQuarter
    ...
    it('should return false when CalendarQuarter is null', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2020, QuarterNumber.Q3)
      const calendarQuarter2 = (null as any) as CalendarQuarter
    ...
    it('should return false when type to test is not a CalendarQuarter', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2020, QuarterNumber.Q4)
      const calendarQuarter2 = new CalendarYear(2020) as any
  ...
  describe('greater than operator --', () => {
    it('should return true when left side is greater than right side and they differ by only QuarterNumber', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2000, QuarterNumber.Q2)
      const calendarQuarter2 = new CalendarQuarter(2000, QuarterNumber.Q1)

      // Act
      const result = calendarQuarter1 > calendarQuarter2
    ...
    it('should return true when left side is greater than right side and they differ by only Year', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2001, QuarterNumber.Q1)
      const calendarQuarter2 = new CalendarQuarter(2000, QuarterNumber.Q1)
    ...
    it('should return false when left side is less than right side', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2000, QuarterNumber.Q2)
      const calendarQuarter2 = new CalendarQuarter(2020, QuarterNumber.Q1)
    ...
    it('should return false when left side is equal to right side', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2000, QuarterNumber.Q3)
      const calendarQuarter2 = new CalendarQuarter(2000, QuarterNumber.Q3)
  ...
  describe('less than operator --', () => {
    it('should return false when left side is greater than right side', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2000, QuarterNumber.Q2)
      const calendarQuarter2 = new CalendarQuarter(1999, QuarterNumber.Q2)
    ...
    it('should return true when left side is less than right side', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2000, QuarterNumber.Q2)
      const calendarQuarter2 = new CalendarQuarter(2020, QuarterNumber.Q2)
    ...
    it('should return false when left side is equal to right side', () => {
      // Arrange
      const calendarQuarter1 = new CalendarQuarter(2000, QuarterNumber.Q2)
      const calendarQuarter2 = new CalendarQuarter(2000, QuarterNumber.Q2)
  ...
  describe('constructor --', () => {
    it('should return same value passed to constructor when getting', () => {
      ...
      const calendarQuarter = new CalendarQuarter(validYear, validQuarter)

      // Act
      const year = calendarQuarter.year
      const quarter = calendarQuarter.quarterNumber
    ...
    it('should return UnitOfTimeGranularity with value of Quarter when getting', () => {
      ...
      const calendarQuarter = new CalendarQuarter(year, quarter)

      // Act
      const unitOfTimeGranularity = calendarQuarter.unitOfTimeGranularity
    ...
    it('should return UnitOfTimeKind with value of Calendar when getting', () => {
      ...
      // Act
      const unitOfTimeKind = calendarQuarter.unitOfTimeKind
    ...
    it('should throw error when parameter year is undefined', () => {
      ...
      // Act
      const constructor = () => new CalendarQuarter(year, quarter)
    ...
    it('should throw error when parameter quarterNumber is undefined', () => {
      ...
      // Act
      const constructor = () => new CalendarQuarter(year, quarterNumber)
  ...
  describe('toString --', () => {
    it('should return friendly string representation when called', () => {
      ...
      // Act
      const result = calendarQuarter.toString()
