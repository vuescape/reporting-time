...
describe('ReportingPeriodExtensions.Serialization --', () => {
  ...
  describe('deserializeFromString --', () => {
    ...
    it('should throw an Error when the serialized reportingPeriod has a malformed token representing the start of reportingPeriod', () => {
      // Arrange
      const reportingPeriodStrings = [
        'c-201a-11,c-2017-10',
        'c-xxxx-11,c-2017-10',
    ...
    // tslint:disable-next-line: max-line-length
    it('should throw an Error when the serialized reportingPeriod has a malformed token representing the end  of reportingPeriod', () => {
      // Arrange
      const reportingPeriodStrings = [
        'c-2017-04,c-201a-11',
        'c-2017-04,c-xxxx-11',
    ...
    // tslint:disable-next-line: max-line-length
    it('should be deserialized correctly when reportingPeriod is a well formed ReportingPeriod of CalendarMonth string', () => {
      // Arrange
      const reportingPeriodString = 'c-2001-01,c-2001-02'
      const expected = new ReportingPeriod(
        new CalendarMonth(2001, MonthNumber.One),
    ...
    // tslint:disable-next-line: max-line-length
    it('should be deserialized correctly when reportingPeriod is a well formed ReportingPeriod of CalendarQuarter string', () => {
      // Arrange
      const reportingPeriodString = 'c-2001-Q1,c-2001-Q2'
      const expected = new ReportingPeriod(
        new CalendarQuarter(2001, QuarterNumber.Q1),
    ...
    // tslint:disable-next-line: max-line-length
    it('should be deserialized correctly when reportingPeriod is a well formed ReportingPeriod of CalendarYear string', () => {
      // Arrange
    ...
    // tslint:disable-next-line: max-line-length
    it('should be deserialized correctly when reportingPeriod is a well formed ReportingPeriod of FiscalMonth string', () => {
      // Arrange
      const reportingPeriodString = 'f-2001-01,f-2001-02'
      const expected = new ReportingPeriod(
        new FiscalMonth(2001, MonthNumber.One),
    ...
    // tslint:disable-next-line: max-line-length
    it('should be deserialized correctly when reportingPeriod is a well formed ReportingPeriod of FiscalQuarter string', () => {
      // Arrange
      const reportingPeriodString = 'f-2001-Q1,f-2001-Q2'
      const expected = new ReportingPeriod(
        new FiscalQuarter(2001, QuarterNumber.Q1),
    ...
    // tslint:disable-next-line: max-line-length
    it('should be deserialized correctly when reportingPeriod is a well formed ReportingPeriod of FiscalYear string', () => {
      // Arrange
  ...
  describe('serializeToString --', () => {
    it('should return expected serialized string representation of reportingPeriod', () => {
      ...
      const reportingPeriods: Map<string, ReportingPeriod> = new Map([
        ...
        [
          'c-2017-Q2,c-2018-Q4',
          new ReportingPeriod(new CalendarQuarter(2017, QuarterNumber.Q2), new CalendarQuarter(2018, QuarterNumber.Q4)),
        ],
        [
          'f-2017-Q2,f-2018-Q4',
          new ReportingPeriod(new FiscalQuarter(2017, QuarterNumber.Q2), new FiscalQuarter(2018, QuarterNumber.Q4)),
        ],
